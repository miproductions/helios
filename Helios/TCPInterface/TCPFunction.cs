...
{
    public abstract class TCPFunction
    {
        private bool _debug;
        private BaseTCPInterface _sourceInterface;
        ...
        protected TCPFunction(BaseTCPInterface sourceInterface)
        {
            _sourceInterface = sourceInterface;
        }

        public BaseTCPInterface SourceInterface
        {
            get
            {
